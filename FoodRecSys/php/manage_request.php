...
if ($jsonobj =='Non è stato possibile raccomandare nessuna ricetta mediante la parola chiave espressa'){
	...
	<div class="col md-1 text-center button-container"> 
        <a href="../html/form.html" class="link-button">COME BACK</a> 
    </div>
</div>';
    echo($html);
}
    ...
    $etichettan = ($jsonobj['etichettan']);
 	$_SESSION['nomericettasinistra1'] = ($jsonobj['name']);
    $_SESSION['nomericettadestra1'] = ($jsonobj['namen']);
	$_SESSION['ordinamentosinistra1'] = ($jsonobj['ordinamento']);
    $_SESSION['ordinamentodestra1'] = ($jsonobj['ordinamenton']);
	...
	$random = rand(0,1);
        ...
        <form id="recipeForm" method="post" action="../php/quest_salato.php">                
