...
if ($jsonobj ==NULL){
	...
	<div class="col md-1 text-center button-container"> 
        <a href="../html/form2.html" class="link-button">COME BACK</a> 
    </div>
</div>';
    echo($html);
}
    ...
    $etichettan = ($jsonobj['etichettan']);
 	$_SESSION['nomericettasinistra3'] = ($jsonobj['name']);
    $_SESSION['nomericettadestra3'] = ($jsonobj['namen']);
    $_SESSION['ordinamentosinistra3'] = ($jsonobj['ordinamento']);
    $_SESSION['ordinamentodestra3'] = ($jsonobj['ordinamenton']);
	...
	$random = rand(0,1);
        ...
        <form id="recipeForm" method="post" action="goodbye.php">                
