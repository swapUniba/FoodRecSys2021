							...
							<div class="col-lg-6 blog-item-wrapper recipe">
                                <div class="blog-item recipe-content">
                                    ...
                                    <div class="blog-text">
                                        ...
                                        <!-- Here can insert the description -->
												...
												<p><font color="black">
                                                        ...
                                                        switch ($showExpl){
                                                            ...
                                                            case 1: //two expl concat
                                                                ...
                                                                break;
                                                            case 2: //two rec expla
                                                                $explanationshow = "";
                                                                if ($dish == "main_exp")
                                                                {
                                                                    $explanationshow = $explanations[$dish][$mainTypeExpl];
                                                                }
                                                                if ($dish == "second_exp")
                                                                {
                                                                    $explanationshow = $explanations[$dish][$secondTypeExpl];
                                                                }
                                                                if ($dish == "dessert_exp")
                                                                {
